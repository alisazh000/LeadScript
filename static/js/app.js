...
const i18n = {
  en: {
    ...
    logout: "Logout",
    aiSub: "Built-in AI assistant (integrated in Script Generator)",
    send: "Ask AI",
    saveChat: "Quick Plan",
    ...
    savePlanPrompt: "Build a detailed 7-day content plan with hooks, scripts, and CTA for each day.",
    namePlaceholder: "Name",
    emailPlaceholder: "Email",
    passwordPlaceholder: "Password (min 8)",
    askPlaceholder: "Ask about your script, audience, hook, CTA, or positioning...",
  ...
  ru: {
    ...
    logout: "Выйти",
    aiSub: "Встроенный AI ассистент (внутри генератора сценариев)",
    send: "Спросить AI",
    saveChat: "Быстрый план",
    ...
    savePlanPrompt: "Сделай подробный контент-план на 7 дней: хуки, сценарии и CTA на каждый день.",
    namePlaceholder: "Имя",
    emailPlaceholder: "Email",
    passwordPlaceholder: "Пароль (минимум 8)",
    askPlaceholder: "Задай вопрос по сценарию, аудитории, хукам, CTA или позиционированию...",
